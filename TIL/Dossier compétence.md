...
**Stack technique :** Spark, Scala, AWS (S3, EMR, Glue), Airflow, Databricks, Delta Lake, Unity Catalog, Autoloader, Python

**Équipe :** X Data Engineers, X Front-ends, X Fullstack Engineers, 1 PO, 1 Lead Tech